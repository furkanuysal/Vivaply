...
namespace Vivaply.API.Modules.Features.Location.Services.Implementations
{
    public sealed class NominatimService(HttpClient http, IMemoryCache cache) : INominatimService
    {
