  ...
  return (
    <>
      <button
        ...
        } w-full py-3 text-gray-400 hover:bg-gray-700/50 hover:text-white rounded-xl transition-all duration-200 group`}
        title={isCollapsed ? t("languageSelection.language") : ""}
      >
        <GlobeAltIcon className="w-6 h-6 shrink-0 group-hover:text-blue-400 transition-colors" />
        {!isCollapsed && (
      ...
      {isOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm animate-fade-in">
          <div className="bg-gray-800 border border-gray-700 rounded-2xl shadow-2xl w-full max-w-sm overflow-hidden transform transition-all scale-100">
            {/* Header */}
                ...
                <button
                  ...
                  className={`w-full flex items-center justify-between p-3 rounded-xl transition-all ${
                    i18n.language === lang.code
                      ? "bg-blue-600/10 border border-blue-600/50 text-blue-400"
